...
const Footer = function () {
  return (
    <footer className="flex justify-center pt-6">
      <a
        className="m-3 transition duration-500 hover:scale-125"
        href="https://ctftime.org/team/176008"
      >
        <Flag color={"white"} size={40} />
      </a>
      <a
        className="m-3 transition duration-500 hover:scale-125"
        href="mailto:styrelsen@royalroppers.team"
      >
      ...
      <a
        className="m-3 transition duration-500 hover:scale-125"
        href="https://github.com/RoyalRoppers"
      >
        <GithubLogo color={"white"} size={40} />
      </a>
      <a
        className="m-3 transition duration-500 hover:scale-125"
        href="https://twitter.com/royal_roppers"
      >
