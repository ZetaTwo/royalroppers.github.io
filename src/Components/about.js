    ...
    return (
        <div className="pt-2 px-3 flex flex-col">
            <p className="default-text text-justify m-auto text-xl max-w-3xl p-2">
                ...
                Check out our ranking and past results on <a className="text-[#f9c867]" href="https://ctftime.org/team/176008">our CTFTime page</a>.
            </p>
            <p className="text-center pt-3 pb-3 default-text text-2xl">
                Want to play CTFs with us? <a className="text-[#f9c867] underline underline-offset-2" href="https://forms.gle/uVaYpFLjF7a6JGGC7">Submit an application</a>
            </p>
        </div>
    );
};
