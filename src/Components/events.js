...
const Event = function ({ company, description, logo }) {
  return (
    <div className="max-w-lg px-5 py-3 transform transition duration-500 hover:scale-105 hover:bg-[#3b5998]/90 rounded-lg">
    ...
    <div className="pt-8 pb-6 px-3">
      ...
      <ol className="mx-auto max-w-lg border-gray-200 list-none">
        {json.event.map((e) => {
          return (
            <li key={e.event_name}>
              <time className="mb-1 pt-3 text-xl font-normal leading-none text-gray-400 dark:text-gray-500">
                {e.date}
              </time>
              <Event
